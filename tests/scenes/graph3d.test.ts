...
describe('normalizeGraph3DSeries', () => {
  it('builds a graph from node metadata edges and explicit links', () => {
    const graph = normalizeGraph3DSeries([
      { id: 'graph', color: '#4f46e5', data: [
        { id: 'alpha', label: 'Alpha', x: -3, y: 1, z: 2, meta: { color: '#60a5fa', size: 1.3, edges: ['beta'] } },
        { id: 'beta', label: 'Beta', x: 2, y: -1, z: -2, meta: { color: '#22c55e', edges: [{ target: 'gamma', weight: 2 }] } },
        { id: 'gamma', label: 'Gamma', x: 4, y: 2, z: 0, meta: { color: '#f97316' } },
      ] },
    ], { links: [{ source: 'alpha', target: 'gamma', kind: 'witness' }] }, ['#6366f1']);
